    ...
    checkOccupiedBeds: function (total) {
        let tooMuch = false,
            ...
            checkAvailableBeds = function (str) {
                let existentTotal = parseInt(window.localStorage.getItem(str + editRes), 10),
                    checkBedStorage = parseInt(window.localStorage.getItem(str), 10);
