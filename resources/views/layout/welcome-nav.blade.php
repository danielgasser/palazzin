                ...
                <ul id="main-nav-welcome" class="nav navbar-nav navbar-left multi-level">
                    @if(Auth::check())
                        ...
                        @else
                            ...
                            <li class="{{ Request::is('user/profile') ? 'active' : '' }}"><a href="{{URL::to('user/profile')}}"><i class="fas fa-user"></i> {{trans('address.my_m')}} {{trans('navigation.profile')}}</a></li>
                            ...
                            <li class=""><a href="https://www.youtube.com/playlist?list=PL4O5JnnqaCJig1Hs2scxYKV3i_CZdUJHB" target="_blank"><i class="fa fa-question" aria-hidden="true"></i>&nbsp;Anleitungen</a>
                            </li>
