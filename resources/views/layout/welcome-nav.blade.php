                ...
                <ul id="main-nav-welcome" class="nav navbar-nav navbar-left multi-level">
                    @if(Auth::check())
                        ...
                        @else
                            ...
                            <li id="readIt"><a style="z-index: 1000; border: 2px solid #b7282e !important; background-color: white !important; color: #b7282e !important;" target="_blank" href="{{URL::to('/files/___checklist/Liste_Handwerker.pdf')}}"><div>Handwerkerverzeichnis</div></a></li>
