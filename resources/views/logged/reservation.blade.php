   ...
   @section('scripts')
    ...
    <script>
            var locale = '{{Lang::get('formats.langlangjs')}}',
                ...
                weekdayNames = {!!(Lang::get('calendar.weekdays'))!!},
                ...
                langRes = {!!(Lang::get('reservation'))!!},
                langUser = {!!(Lang::get('userdata'))!!},
                langBill = {!!(Lang::get('bill'))!!},
                langDialog = {!!(Lang::get('dialog'))!!},
                timer = '',
                errors = {!!json_encode($errors)!!},
                todayIs ='{{trans('navigation.today_is')}}',
                baseUrl = '{{URL::asset('')}}',
                homeUrl = '{{URL::to('/')}}',
                guestLabel = {!!(Lang::get('reservation.guest_many'))!!},
                bedLabel = {!!(Lang::get('reservation.beds'))!!},
