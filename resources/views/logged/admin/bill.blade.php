...
<div id="bill_searcher">
    <table style="width: 100%;">
        @include('layout.search_bill_tables', ['users' => $users])
    </table>
...
<div id="after-totals">
    <div class="table-responsive">
        ...
        <table id="allReservations" class="table tablesorter" style="top: 9px">
            @if(sizeof($allBills) > 0)
                <?php $i = 0;?>
                        ...
                        <table id="bill_totals" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    @else
                                        <th colspan="2" class="white-row"></th>
                                    @endif
                                </tr>
                            </thead>
                            <tbody>
