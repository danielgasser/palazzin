...
$(document).on('change', '[id^="reservation_guest_guests_"]', function () {
  let id = $(this).attr('id').split('_')[3],
      ...
      dates = {
    startDate: $('#reservation_guest_started_at_' + id).val(),
    endDate: $('#reservation_guest_ended_at_' + id).val()
  };
...
$(document).on('click', '[id*="clone_guest_"]', function (e) {
  ...
  let counter = $('[id^="guests_date_"]').length,
      div = $(window.guestEntryView).html(function (i, old) {
  ...
  guestDateEl.datepicker().on('changeDate', function (e) {
    ...
    V3Reservation.calcAllPrices();
    V3Reservation.setGuestHeaderText(id, {
      startDate: window.startGuestPicker[id].datepicker('getDate'),
      endDate: window.endGuestPicker[id].datepicker('getDate')
    }, $('#reservation_guest_guests_' + id).val(), $('#reservation_guest_num_' + id).val(), $('#number_nights_' + id).text());
  });
