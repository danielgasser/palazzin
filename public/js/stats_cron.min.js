var distinctArray = function (arr) {
    ...
    var htmlString = '',
        tableHeader = '<thead>' + '<tr>' + '<th>' + '<h6>Name/Vorname</h6>' + '</th>' + '<th>' + '<h6>Total Gäste</h6>' + '</th>' + '<th>' + '<h6>Total Gastnächte</h6>' + '</th>' + '</tr>' + '</thead>';
    ...
    for (var i = 0; i < data.length; i++) {
        var d = data[i];
        htmlString += '<tr>' + '<td>' + d.name + '</td>' + '<td>' + d.total + '</td>' + '<td>' + d.total_n + '</td>' + '</tr>';
    }
